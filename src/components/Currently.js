    ...
    return (
        <section className="bg-white rounded-md shadow-sm p-10 text-center grid md:grid-cols-2 gap-4 items-center mb-5">
             <div>
                 ...
                 {props.location.city && <div className="flex items-center justify-center mb-5">
                ...
                <div className="flex justify-center">
                    <div className="relative">
                        ...
                        {!props.current.Temperature && <span className="text-8xl">--</span>}
            ...
            <div className="grid justify-center">
                ...
                <div>{props.current.WeatherText}</div>
            </div>
        </section>
    )
}